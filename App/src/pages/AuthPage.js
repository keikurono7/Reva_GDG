...
export default function AuthPage() {
  ...
  if (!userType) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[radial-gradient(circle_at_top,rgba(251,191,36,0.12),transparent_26%),linear-gradient(180deg,#fffdf9_0%,#fff8f2_58%,#f6efe7_100%)] p-4 text-slate-900 sm:p-6">
        <div className="max-w-4xl w-full">
          <h1 className="mb-8 text-center text-3xl font-bold sm:mb-12 sm:text-5xl">
            Join{" "}
          ...
          <div className="grid gap-5 md:grid-cols-2 md:gap-8">
            ...
            <motion.div
              ...
              className="cursor-pointer rounded-3xl border border-white/80 bg-white/88 p-6 shadow-[0_18px_45px_rgba(15,23,42,0.06)] sm:p-8"
            >
              <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-amber-400 to-orange-500 sm:mb-6 sm:h-20 sm:w-20">
                <User className="h-8 w-8 text-white sm:h-10 sm:w-10" />
              </div>
              <h2 className="mb-2 text-center text-2xl font-bold sm:mb-3 sm:text-3xl">Politician</h2>
            ...
            <motion.div
              ...
              className="cursor-pointer rounded-3xl border border-white/80 bg-white/88 p-6 shadow-[0_18px_45px_rgba(15,23,42,0.06)] sm:p-8"
            >
              <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-2xl bg-slate-900 sm:mb-6 sm:h-20 sm:w-20">
                <Users className="h-8 w-8 text-white sm:h-10 sm:w-10" />
              </div>
              <h2 className="mb-2 text-center text-2xl font-bold sm:mb-3 sm:text-3xl">Citizen</h2>
              <p className="mb-4 text-center text-slate-600">
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(251,191,36,0.12),transparent_26%),linear-gradient(180deg,#fffdf9_0%,#fff8f2_58%,#f6efe7_100%)] p-4 text-slate-900 sm:flex sm:items-center sm:justify-center sm:p-6">
      <motion.div
        initial={{ opacity: 0, scale: 0.95 }}
        animate={{ opacity: 1, scale: 1 }}
        className="max-h-[92vh] w-full max-w-md overflow-y-auto rounded-3xl border border-white/80 bg-white/90 p-5 shadow-[0_24px_70px_rgba(15,23,42,0.08)] backdrop-blur-xl sm:p-8"
      >
        <div className="mb-6 text-center sm:mb-8">
          <div
            className={`mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl sm:h-20 sm:w-20 ${
              userType === "politician"
                ? "bg-gradient-to-br from-amber-400 to-orange-500"
                : "bg-slate-900"
            }`}
          >
            {userType === "politician" ? <User size={32} className="text-white sm:h-10 sm:w-10" /> : <Users size={32} className="text-white sm:h-10 sm:w-10" />}
          </div>
